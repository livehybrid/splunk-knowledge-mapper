...
const runCommands = {
    win32: {
        ...
        link: () => shell.exec('mklink /D "%SPLUNK_HOME%\\etc\\apps\\knowledge-mapper-view" "%cd%\\demo\\splunk-app"'),
    },
    nix: {
        ...
        link: () => shell.exec('ln -s $PWD/demo/splunk-app $SPLUNK_HOME/etc/apps/knowledge-mapper-view-demo-app'),
    },
};
